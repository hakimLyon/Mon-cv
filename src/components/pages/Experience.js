...
const Experience = (props)=>{
  return(
    <div className="h-screen justify-center items-center bg-yellow-300 opacity-95">
      ...
      <center className="py-3 font-bold"><p><em>Entreprise Lyon Dynasty
            Créer, réviser et corriger des Communications d'entreprise et marketing sur le web digital (E-commerce) .</em></p>
            </center>
    </div>
  )
}
